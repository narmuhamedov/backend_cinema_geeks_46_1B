...
class Films(models.Model):
    GENRE_CHOICE = (("Ужасы", "Ужасы"), ("Комедия", "Комедия"), ("Боевик", "Боевик"))
    ...
    description = models.TextField(
        verbose_name="Укажите описание к фильму", default="Lorem Ipsum", null=True
    )
...
class ReviewFilm(models.Model):
    review_films = models.ForeignKey(
        Films, on_delete=models.CASCADE, related_name="review_films"
    )
